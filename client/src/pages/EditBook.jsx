...
const EditBook = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get(`http://localhost:8081/books/${id}`).then((res) =>{
    ...
    const handleEditBook = () => {
        ...
        setLoading(true);
        axios.put(`http://localhost:8081/books/${id}`, data).then(() => {
            setLoading(false);
  ...
  return (
    <div className='p-4'>
        ...
        <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
            ...
            <div className="my-4">
                <label htmlFor="" className="text-xl mr-4 text-gray-500">Content</label>
